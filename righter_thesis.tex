...
\titlespacing*{\subsection}{0pt}{2.0ex plus 0.8ex minus .2ex}{1.2ex plus .2ex}

\AtBeginEnvironment{definition}{\begin{spacing}{1.12}}
\AtEndEnvironment{definition}{\end{spacing}}
\AtBeginEnvironment{theorem}{\begin{spacing}{1.12}}
\AtEndEnvironment{theorem}{\end{spacing}}
\AtBeginEnvironment{corollary}{\begin{spacing}{1.12}}
\AtEndEnvironment{corollary}{\end{spacing}}
\AtBeginEnvironment{example}{\begin{spacing}{1.15}}
\AtEndEnvironment{example}{\end{spacing}}

\AtBeginEnvironment{definition}{\vspace{0.75\baselineskip}\begin{spacing}{1.12}}
\AtEndEnvironment{definition}{\end{spacing}\vspace{0.5\baselineskip}}
\AtBeginEnvironment{example}{\vspace{0.75\baselineskip}\begin{spacing}{1.15}}
\AtEndEnvironment{example}{\end{spacing}\vspace{0.5\baselineskip}}
\AtBeginEnvironment{theorem}{\vspace{0.75\baselineskip}\begin{spacing}{1.12}}
\AtEndEnvironment{theorem}{\end{spacing}\vspace{0.5\baselineskip}}
\AtBeginEnvironment{corollary}{\vspace{0.75\baselineskip}\begin{spacing}{1.12}}
\AtEndEnvironment{corollary}{\end{spacing}\vspace{0.5\baselineskip}}
...
\subsection*{Intuitive Demonstration (Placeholder)}
To be completed: an intuitive demonstration using the law of total probability to compute
$P(S_N = 4)$ for the same setup as Example~\ref{ex:poisson}.

Suggested structure to fill in:
\begin{itemize}
    \item Condition on $N=n$ and write $P(S_N=4)=\sum_{n=0}^{\infty}P(S_n=4)P(N=n)$.
    \item Compute the first nonzero terms for $n=1,2,3,4$ and justify why larger terms are
    still valid in the summation.
    \item Compare this direct law-of-total-probability computation with the recursive value in
    Example~\ref{ex:poisson}.
\end{itemize}
