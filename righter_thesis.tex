...
\AtBeginEnvironment{definition}{\vspace{1.5\baselineskip}\begin{spacing}{1.3}}
\AtEndEnvironment{definition}{\end{spacing}\vspace{1.0\baselineskip}}
\AtBeginEnvironment{example}{\vspace{1.5\baselineskip}\begin{spacing}{1.3}}
\AtEndEnvironment{example}{\end{spacing}\vspace{1.0\baselineskip}}
\AtBeginEnvironment{theorem}{\vspace{1.5\baselineskip}\begin{spacing}{1.3}}
\AtEndEnvironment{theorem}{\end{spacing}\vspace{1.0\baselineskip}}
\AtBeginEnvironment{corollary}{\vspace{1.5\baselineskip}\begin{spacing}{1.3}}
\AtEndEnvironment{corollary}{\end{spacing}\vspace{1.0\baselineskip}}
